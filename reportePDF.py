...
class reportePDF(object):
    ...
    def _encabezadoPiePagina(canvas, archivoPDF):
        ...
        # Encabezado
        encabezadoNombre = Paragraph("LACATULI 1.0", estilos["Normal"])
        ...
        # Pie de página
        piePagina = Paragraph("Reporte generado por LACATULI.", estilos["Normal"])
    ...
    def Exportar(self):
        ...
        archivoPDF = SimpleDocTemplate(self.nombrePDF, leftMargin=50, rightMargin=50, pagesize=letter,
                                       title="Reporte PDF", author="LACATULI")
